...
class Wishlist(models.Model):
    id = models.BigAutoField(primary_key=True)
    user_id = models.ForeignKey(Customer, on_delete=models.CASCADE, related_name='wishlist_users')
    product_id =models.ForeignKey(myprodect, on_delete=models.CASCADE, related_name='wishlist_products')