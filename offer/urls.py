...
urlpatterns = [
     ...
     path('product_offer_action<int:id>',views.product_offer_action,name='product_offer_action'),
     path('category_offer',views.category_offer,name='category_offer'),
     path('add_category_offer',views.add_category_offer,name='add_category_offer'),
     path('category_offer_action<int:id>',views.category_offer_action,name='category_offer_action'),
